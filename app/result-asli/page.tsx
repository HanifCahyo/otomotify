        ...
        <Card className="p-6 bg-neutral border border-border">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <div className="relative">
                <Image
                  src="/images/HGP.webp"
                  alt="Contoh Sparepart Palsu"
                  width={300}
                  height={200}
                  className="w-full h-48 object-cover rounded-lg border-2 border-warning opacity-70"
                />
          ...
          <div className="mt-4 p-4 bg-success/10 rounded-lg">
            <p className="text-sm text-gray-700">
              <span className="font-semibold text-success">Kesimpulan:</span>{" "}
              Sparepart yang Anda scan memiliki karakteristik asli yang
              terverifikasi oleh sistem AI kami.
            </p>
          </div>
        </Card>
